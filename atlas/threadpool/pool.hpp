...
namespace boostpp {
  namespace threadpool {
    ...
    public:
       ...
       */
      thread_pool(size_t initial_threads = 0) : _core(new pool_core_type),
        _shutdown_controller(nullptr, std::bind(&pool_core_type::shutdown, _core))
      {
       ...
       * \see SizePolicy
       */
      size_controller_type size_controller() { return _core->size_controller(); }
       ...
       */
      bool schedule(task_type const & task) { return _core->schedule(task); }

      /*! Returns the number of tasks which are currently executed.
       * \return The number of active tasks.
       */
      size_t active() const { return _core->active(); }

      /*! Returns the number of tasks which are ready for execution.
       * \return The number of pending tasks.
       */
      size_t pending() const { return _core->pending(); }
       ...
       */
      void wait(size_t task_threshold = 0) const { _core->wait(task_threshold); }
