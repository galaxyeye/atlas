...
// The safe_btree_map class is needed mainly for its constructors.
  ...
  public:
    // Default constructor.
    safe_btree_map(const key_compare &comp = key_compare(), const allocator_type &alloc = allocator_type()) :
    ...
    safe_btree_map(InputIterator b, InputIterator e, const key_compare &comp = key_compare(),
